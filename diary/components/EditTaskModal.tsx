...
interface EditTaskModalProps {
  visible: boolean;
  onClose: () => void;
  onSubmit: (task: { id: string; title: string; description: string; deadline: Date | null }) => void;
  task: Task;
}

export function EditTaskModal({ visible, onClose, onSubmit, task }: EditTaskModalProps) {
  ...
  // Оновлюємо локальний стан при зміні задачі
  useEffect(() => {
    setTitle(task.title);
            ...
            <Animated.View style={[
              ...
              <ThemedView style={[styles.modalContent, { maxHeight: modalHeight }]}>
                <View style={styles.header}>
                  <ThemedText style={styles.title}>Редагувати завдання</ThemedText>
                ...
                <View style={styles.buttonContainer}>
                  ...
                  <TouchableOpacity
                    ...
                    disabled={!title.trim()}
                  >
                    <ThemedText style={styles.buttonText}>Зберегти</ThemedText>
                  </TouchableOpacity>
                </View>
              </ThemedView>
            </Animated.View>
